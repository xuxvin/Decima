Contributing to Decima Core
============================

The Decima Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Decima Core project, and is not to be
confused with overall Decima Network Protocol consensus changes.

Whether a pull request is merged into Decima Core rests with the project merge
...
Patches that change Decima consensus rules are considerably more involved than
...
Where a patch set proposes to change the Decima consensus, it must have been
...
The project leader is the release manager for each Decima Core release.
