...
RESOURCES += src/qt/decima.qrc src/qt/decima_locale.qrc

TRANSLATIONS += src/qt/locale/decima_bg.ts \
                src/qt/locale/decima_de.ts \
                src/qt/locale/decima_en.ts \
                src/qt/locale/decima_es.ts \
                src/qt/locale/decima_fi.ts \
                src/qt/locale/decima_fr.ts \
                src/qt/locale/decima_it.ts \
                src/qt/locale/decima_ja.ts \
                src/qt/locale/decima_pl.ts \
                src/qt/locale/decima_pt.ts \
                src/qt/locale/decima_ru.ts \
                src/qt/locale/decima_sk.ts \
                src/qt/locale/decima_sv.ts \
                src/qt/locale/decima_vi.ts \
                src/qt/locale/decima_zh_CN.ts \
                src/qt/locale/decima_zh_TW.ts
