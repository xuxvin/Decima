...
In order to support loading of multiple wallets in decima-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is decima.cpp.
...
Changes to decima.cpp
----------------------
decima.cpp is the entry point into decima-qt, and as such, will require some minor modifications to provide hooks for
