...
* WebSocket: [https://github.com/decimaproject/insight-api-decima#web-socket-api](https://github.com/decimaproject/insight-api-decima#web-socket-api) 
* API: [https://github.com/decimaproject/insight-api-decima#swifttx-transactions](https://github.com/decimaproject/insight-api-decima#swifttx-transactions) 
...
By default, the Decima Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Decima Core daemon:
