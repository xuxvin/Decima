...
#   c) node1 mines 32 blocks, so now node 0 has 60001dia, node 1 has 4250dia, node2 has none.
#   d) node0 sends 601 dia to node2, in two transactions (301 dia, then 300 dia).
