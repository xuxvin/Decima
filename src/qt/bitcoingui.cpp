                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Decima Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a Decima address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and decima: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zDIA"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Decima Core"), this);
    aboutAction->setStatusTip(tr("Show information about Decima Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Decima"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your Decima addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified Decima addresses"));
    ...
    openAction->setStatusTip(tr("Open a Decima: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the Decima Core help message to get a list with possible Decima command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("Decima Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Decima network", "", count));
}
...
{
    QString strTitle = tr("Decima Core"); // default title
