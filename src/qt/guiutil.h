...
/** Utility functions used by the Decima Qt UI.
 */
namespace GUIUtil
{
...
// Render Decima addresses in monospace font
...
// Parse "decima:" URI into recipient object, return true on successful parsing
