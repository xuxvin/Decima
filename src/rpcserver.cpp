...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* Decima features */
        {"decima", "masternode", &masternode, true, true, false},
        {"decima", "listmasternodes", &listmasternodes, true, true, false},
        {"decima", "getmasternodecount", &getmasternodecount, true, true, false},
        {"decima", "masternodeconnect", &masternodeconnect, true, true, false},
        {"decima", "masternodecurrent", &masternodecurrent, true, true, false},
        {"decima", "masternodedebug", &masternodedebug, true, true, false},
        {"decima", "startmasternode", &startmasternode, true, true, false},
        {"decima", "createmasternodekey", &createmasternodekey, true, true, false},
        {"decima", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"decima", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"decima", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"decima", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"decima", "getmasternodescores", &getmasternodescores, true, true, false},
        {"decima", "mnbudget", &mnbudget, true, true, false},
        {"decima", "preparebudget", &preparebudget, true, true, false},
        {"decima", "submitbudget", &submitbudget, true, true, false},
        {"decima", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"decima", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"decima", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"decima", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"decima", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"decima", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"decima", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"decima", "checkbudgets", &checkbudgets, true, true, false},
        {"decima", "mnsync", &mnsync, true, true, false},
        {"decima", "spork", &spork, true, true, false},
        {"decima", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"decima", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use decimad, or the -server option to decima-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> decima-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:22882/\n";
}
